...
// 		// Create a filter to match the TableID
// 		filter := bson.M{"table_id": tableID}

// 		// Delete the table
// 		result, err := tableCollection.DeleteOne(ctx, filter)
// 		if err != nil {
// 			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occurred while deleting the table"})
// 			cancel()
// 			return
// 		}
...
// 		defer cancel()
// 		c.JSON(http.StatusOK, gin.H{"status": "table successfully deleted"})
// 	}
// }
